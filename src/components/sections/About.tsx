          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="glass-card overflow-hidden">
              ...
              <div className="p-5 font-mono text-sm space-y-3">
                <div><span className="text-muted">// current role</span><br /><span className="text-cyan">const</span><span className="text-white"> role </span><span className="text-muted">= </span><span className="text-green">&quot;Forward Deployed Engineer @ Salesforce&quot;</span><span className="text-muted">;</span></div>
